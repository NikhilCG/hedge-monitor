...
document.getElementById('f-country').addEventListener('change',()=>{ renderFunds(); renderNews(); renderActions(); renderSignals(); renderAnalysts(); renderCommon(); renderBanner(); });
...
async function loadData(initial) {
  try {
    ...
    populateCountries();
    renderActions(); renderCommon(); renderFunds(); renderNews();
